  ...
  $(document).on('click', '#gallery-metabox a.gallery-add', function(e) {
    ...
    file_frame.on('select', function() {
      ...
      selection.map(function(attachment, i) {
        ...
        $('#gallery-metabox-list').append('<li><input type="hidden" name="vdw_gallery_id[' + index + ']" value="' + attachment.id + '"><img class="image-preview" src="' + attachment.sizes.thumbnail.url + '"><div class="fakeDiv"></div><a class="change-image changeClass" href="#" data-uploader-title="Change image" data-uploader-button-text="Change image"><i class="fa fa-camera fa-lg"></i></a><small class="removeClass"><a class="remove-image" href="#"><i class="fa fa-remove fa-lg"></i></a></small></li>');
      });
    });
